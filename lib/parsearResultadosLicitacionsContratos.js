...
const { createTable, insertIntoTable, existsRecord, getTotalFilesFromExpediente } = require('./sqliteAccions');
            ...
            for(i=0; i<pageData.length; i++) {
                ...
                if(total >= linksPDFs.length) {
                    ...
                    for(n=0; n<linksPDFs.length; n++) {
                        ...
                        insertIntoTable(table+'_files', [fileName, el[0], dataPDFs[n][1], dataPDFs[n][0]])
